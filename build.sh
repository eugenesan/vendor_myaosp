...
#
# Android AOSP/MyAOSP/AOSPA/CM/SLIM/MAHDI build script
# Version 2.0.12
#
...
elif [ -r ${DIR}/vendor/mahdi/config/common.mk ]; then
        VENDOR="mahdi"
        VENDOR_LUNCH=""
...
elif [ -r ${DIR}/vendor/myaosp/configs/common.mk ]; then
        VENDOR="myaosp"
        VENDOR_LUNCH="myaosp_"
